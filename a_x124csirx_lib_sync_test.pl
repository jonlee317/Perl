...
{
#----------- grep measured data ---------------------------------
open(fin, "< x128dsirx_lib_sync_lpe_test.lis");
open(fout, "> temp_perl") ||
...
open(RESULT0,">result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT1,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT2,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT3,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT4,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT5,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT6,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT7,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT8,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT9,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT10,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
...
open(RESULT11,">>result_x128dsirx_lib_sync_lpe_test.txt") ||
die "Error opening file!";
