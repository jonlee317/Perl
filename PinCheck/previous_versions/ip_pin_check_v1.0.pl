...
##
## Notes:
##   - release_directory is the location where all the views of the IP exist in the release structure format
##   - ip_name is the top cell name of the IP (e.g. X110T001). This name should be used in all the views 
##   - reference_file with list of io's of the ip 
## -----------------------------------------------------------------------------
...
die "Error opening file! result_pin_check.txt";
print RESULT0 " This report was generated on $dat \n";
print RESULT0 " For RELEASE  $rel    \n";
print RESULT0 "-------------------------------------------------------------\n";
print RESULT0 "*\t\t\t Summary\t\t\t    *\n";
print RESULT0 "-------------------------------------------------------------\n";
print RESULT0 "*\t\t\t\t\t\t\t    *\n";
print RESULT0 "*\t  Number of REF Pins \t\t= ".$refpins."\t\t    *\n";
print RESULT0 "-------------------------------------------------------------\n";
if (($views eq "ALL") || ($views eq "LEF"))
{
